...
contract PrizeToEnumerableNFTHolderHook is IVaultHooks {
    ...
    function beforeClaimPrize(address, uint8 tier, uint32 prizeIndex, uint96, address) external view returns (address) {
        ...
        return enumerableToken.ownerOf(enumerableToken.tokenByIndex(_randomTokenIndex));
    }
